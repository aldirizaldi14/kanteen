...
class SummaryController extends Controller
{
    ...
    {   
        /*
                ...
                $ak2 = date('H:i', strtotime("19:15"));
                $a3  = date('H:i', strtotime("02:00"));
                $ak3 = date('H:i', strtotime("03:15"));*/ ///pak mada
                ...
                $a2  = date('H:i', strtotime("17:00"));
                $ak2 = date('H:i', strtotime("19:15"));
                $a3  = date('H:i', strtotime("23:00"));
                $ak3 = date('H:i', strtotime("04:30")); //aldi
    ...
    public function ikan($id) {
        ...
        if(($now >= $a1) && ($now <= $ak1)) {
            ...
            return 1;
	event(new TotalIkanListener('error', 0));
        }
    ...
    public function ayam($id) { 
        ...
        if(($now >= $a1) && ($now <= $ak1)) {
            ...
            return 1;
	event(new TotalAyamListener('error', 0));
        }
    ...
    public function daging($id) {
        ...
        if(($now >= $a1) && ($now <= $ak1)) {
            ...
            return 1;
	event(new TotalDagingListener('error', 0));
        }else {
            return 1;
	event(new TotalDagingListener('error', 0));
        }
